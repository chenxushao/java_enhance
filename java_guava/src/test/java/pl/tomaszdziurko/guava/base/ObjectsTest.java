...
public class ObjectsTest {
	...
	public void shouldTestHashcode() throws Exception {
		assertThat(objectsLesson.hashCode()).isEqualTo(
				objectsLesson2.hashCode());
	}
	...
	public void shouldShowHowToStringMethodWorks() throws Exception {
		assertThat(objectsLesson.toString()).isEqualTo(
				"UserProfile{name=name, nickname=nickname, 20}");
