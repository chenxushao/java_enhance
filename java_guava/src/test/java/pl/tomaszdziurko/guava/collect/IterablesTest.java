...
public class IterablesTest {
	...
	public void shouldCheckLengthOfAllElements() throws Exception {
		...
		// then
		assertThat(
				Iterables.all(Lists.newArrayList("Java", "Scala", "Haskell",
						"Groovy", "Java", "Lisp"), lengthPredicate)).isTrue();
	}
	...
	public void shouldCheckIfAtLeastOneElementIsEmptyOrNull() throws Exception {
		...
		// then
		assertThat(
				Iterables.any(Lists.newArrayList("Java", "Scala", "Haskell",
						"Groovy", "Java", "Lisp"), emptyOrNullPredicate))
				.isFalse();
	}
	...
	public void shouldConcat() throws Exception {
		// when
		Iterable<String> concatenatedIterable = Iterables.concat(Lists
				.newArrayList("Java", "Scala", "Haskell", "Groovy", "Java",
						"Lisp"), Lists.newArrayList("Spring", "Hibernate",
				"JSF", "Wicket", "CDI", "Wicket"));
	...
	public void shouldFilterOutSomeNumbers() throws Exception {
		...
		// given
		List<Integer> numbersList = Lists.newArrayList(1, 2, 3, 0, -12, 22,
				430, -1024);

		// when
		Iterable<Integer> filteredList = Iterables.filter(numbersList,
	...
	public void shouldCountElementsInIterable() throws Exception {
		...
		// given
		List<Integer> numbersList = Lists.newArrayList(1, 2, 3, 0, -2, 2, 430,
				2);
	...
	public void shouldPartition() throws Exception {
		...
		// when
		Iterable<List<Integer>> partitionedLists = Iterables.partition(
				numbersList, 5);
	...
	public void shouldConvertToArray() throws Exception {
		...
		Number[] numbersWithTraditionalWay = numbersList
				.toArray(new Number[] {});
