...
public class SplitterDemo2 {
	...
	public void shouldSplitOnRegExp() throws Exception {
		// when
		Iterable<String> iterable = Splitter.onPattern("\\d+").split(
				"Java3Scala4Haskell0Brainfuck5Kotlin");
		List<String> splittedList = convertToList(iterable.iterator());
	...
	@Test
	public void shouldSplitAndOmitEmptyElementsAndWhitespaces()
			throws Exception {
		// when
		Iterable<String> iterable = Splitter.on(";").omitEmptyStrings()
				.trimResults()
				.split("Java;;  ;Scala;;;Haskell;Brainfuck;Kotlin");
		List<String> splittedList = convertToList(iterable.iterator());
	...
	public void shouldSplitForEqualLength() throws Exception {
		// when
		Iterable<String> iterable = Splitter.fixedLength(5).split(
				"HorseHouseGroupDemosScrum");
		List<String> splittedList = convertToList(iterable.iterator());
