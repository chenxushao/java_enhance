...
public class FilesTest extends TestCase {
	...
	public void test6() {
		...
		try {
			...
			err.println("ERROR trying to compare two files '" + fileName1
					+ "' and '" + fileName2 + "' - " + fileIoEx.toString());
		}
	}
	 ...
	 * 
	 * touch方法创建或者更新文件的时间戳。 createTempDir()方法创建临时目录 Files.createParentDirs(File)
	 * 创建父级目录 //getChecksum(File)获得文件的checksum hash(File)获得文件的hash
	 * map系列方法获得文件的内存映射 getFileExtension(String)获得文件的扩展名
