...
public class HashTest extends TestCase {
	...
	public void test1() {
		...
		HashCode hc = function.newHasher().putLong(id)
				.putString(name, Charsets.UTF_8).hash();
	...
	public void test2() {
		...
		HashFunction function = Hashing.md5();
		HashCode hc = function.newHasher().putObject(person, personFunnel)
				.hash();
		System.out.println(hc.hashCode());
	}
	...
	public void test3() {
		...
		List<Person> friendsList = Lists.newArrayList(new Person(2, "bao3",
				"qiang", 21), new Person(1, "bao32", "qiang", 21));
