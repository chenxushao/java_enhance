...
public class OptionalTest extends TestCase {
	...
	/**
	 * null会带来很多问题，从开始有null开始有无数程序栽在null的手里， null的含义是不清晰的，检查null在大多数情况下是不得不做的，
	 * 而我们又在很多时候忘记了对null做检查，在我们的产品真正投入使用的时候， 空指针异常出现了，这是一种讨厌的情况。
	 * 
	...
	/**
	 * 举个例子 普通青年和文艺青年分别写一段SayHello的代码，要求如下，当用户名为null时则称呼“火星人”
	 */
	public void test3() {
		// jdk
		String name = null;
