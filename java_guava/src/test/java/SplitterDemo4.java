...
public class SplitterDemo4 {
	/**
	 * a common task for programmers is to take a string with some delimiter
	 * character and plit that string on the delimiter and obtain an array of
