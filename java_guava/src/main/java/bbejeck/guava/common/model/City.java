...
/**
 * User: Bill Bejeck Date: 4/1/13 Time: 8:40 PM
 */
public class City {
	...
	public City(String name, String zipCode, int population, Climate climate,
	...
	public String toString() {
		return "City{" + "averageRainfall=" + averageRainfall + ", name='"
	...
	public boolean equals(Object o) {
		...
		if (name != null ? !name.equals(city.name) : city.name != null)
			return false;
		if (zipCode != null ? !zipCode.equals(city.zipCode)
				: city.zipCode != null)
			return false;
	...
	public static class Builder {
		...
		public City build() {
			return new City(this.name, this.zipCode, this.population,
					this.climate, this.averageRainfall);
		}
