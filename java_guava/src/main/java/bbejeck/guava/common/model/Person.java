...
/**
 * User: Bill Bejeck Date: 4/23/13 Time: 9:34 PM
 */
public class Person implements Comparable<Person> {
	...
	public Person(String firstName, String lastName, int age, String sex) {
		...
		checkArgument((sex.equals("M") || sex.equals("F")),
				"Sex has to be either M or F");
	}
	...
	public int compareTo(Person o) {
		return ComparisonChain.start()
				...
				.compare(this.age, o.getAge()).compare(this.sex, o.getSex())
				.result();
	}
