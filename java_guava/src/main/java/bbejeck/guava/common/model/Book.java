...
/**
 * User: Bill Bejeck Date: 3/27/13 Time: 10:56 PM
 */
public class Book implements Comparable<Book> {
	...
	public String toString() {
		return Objects.toStringHelper(this).omitNullValues()
				.add("title", title).add("author", author)
				.add("publisher", publisher).add("price", price)
	...
	public int compareTo(Book o) {
		return ComparisonChain.start().compare(this.title, o.getTitle())
	...
	public static class Builder {
		...
		public Book build() {
			return new Book(this.author, this.title, this.publisher, this.isbn,
					this.price);
		}
	}
