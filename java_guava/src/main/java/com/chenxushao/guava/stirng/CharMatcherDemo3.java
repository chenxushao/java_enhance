...
public class CharMatcherDemo3 {
	...
	public void shouldRetainOnlyDigits() throws Exception {
		assertThat(CharMatcher.DIGIT.retainFrom("Hello 1234 567")).isEqualTo(
				"1234567");
	}
	...
	public void shouldRetainDigitsOrWhiteSpaces() throws Exception {
		assertThat(
				CharMatcher.DIGIT.or(CharMatcher.WHITESPACE).retainFrom(
						"Hello 1234 567")).isEqualTo(" 1234 567");
	}

	@Test
	public void shouldRetainNothingAsConstrainsAreExcluding() throws Exception {
		assertThat(
				CharMatcher.DIGIT.and(CharMatcher.JAVA_LETTER).retainFrom(
						"Hello 1234 567")).isEqualTo("");
	}

	@Test
	public void shouldRetainLettersAndDigits() throws Exception {
		assertThat(
				CharMatcher.DIGIT.or(CharMatcher.JAVA_LETTER).retainFrom(
						"Hello 1234 567")).isEqualTo("Hello1234567");
	}

	@Test
	public void shouldCollapseAllDigitsByX() throws Exception {
		assertThat(CharMatcher.DIGIT.collapseFrom("Hello 1234 567", 'x'))
				.isEqualTo("Hello x x");
	}

	@Test
	public void shouldReplaceAllDigitsByX() throws Exception {
		assertThat(CharMatcher.DIGIT.replaceFrom("Hello 1234 567", 'x'))
				.isEqualTo("Hello xxxx xxx");
	}
	...
	public void shouldReturnFirstIndexOfFirstWhitespace() throws Exception {
		assertThat(CharMatcher.WHITESPACE.indexIn("Hello 1234 567")).isEqualTo(
				5);
	}

	@Test
	public void shouldReturnLastIndexOfFirstWhitespace() throws Exception {
		assertThat(CharMatcher.WHITESPACE.lastIndexIn("Hello 1234 567"))
				.isEqualTo(10);
	}

	@Test
	public void shouldRemoveDigitsBetween3and6() throws Exception {
		assertThat(CharMatcher.inRange('3', '6').removeFrom("Hello 1234 567"))
				.isEqualTo("Hello 12 7");
	}
	...
	public void shouldRemoveAllExceptDigitsBetween3and6() throws Exception {
		assertThat(
				CharMatcher.inRange('3', '6').negate()
						.removeFrom("Hello 1234 567")).isEqualTo("3456");
	}
	...
	public void shouldRemoveOnlyStartingDollarsAndKeepOtherUnchanged()
			throws Exception {
		assertThat(
				CharMatcher.is('$').trimLeadingFrom("$$$ This is a $ sign $$$"))
				.isEqualTo(" This is a $ sign $$$");
	}
	...
	public void shouldRemoveStartingEndEndingDollarsAndReplaceOthersWithX()
			throws Exception {
		assertThat(
				CharMatcher.is('$').trimAndCollapseFrom(
						"$$$This is a $ sign$$$", 'X')).isEqualTo(
				"This is a X sign");
	}
	...
	public void shouldRemoveOnlyEndingDollarsAndKeepOtherUnchanged()
		...
		assertThat(
				CharMatcher.is('$')
						.trimTrailingFrom("$$$ This is a $ sign $$$"))
				.isEqualTo("$$$ This is a $ sign ");
	}
	...
	public void shouldRemoveStartingAndEndingDollarsOrWhitespaceAndKeepOtherUnchanged()
			throws Exception {
		assertThat(
				CharMatcher.is('$').or(CharMatcher.is(' '))
						.trimFrom("$$$ This is a $ sign $$$")).isEqualTo(
				"This is a $ sign");
	}
