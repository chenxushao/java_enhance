...
public class ImmutableListDemo1 {
	...
	public final static  List<String> ResortHotelLocation = Arrays.asList(new String[] {
			"B01", "B02", "B03","B04" });
	
	public final static  List<String> PrivilegeHotelsLocation = Arrays.asList(new String[] {
