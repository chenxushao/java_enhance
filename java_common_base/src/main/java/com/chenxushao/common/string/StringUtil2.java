...
public class StringUtil2 {
	 ...
	 * 取一组日期
	 * 
	 * @param bday String 开始日YYYYMMDD
	 * @param eday String 结束日YYYYMMDD
	 * @return String[] 日期型字符数组
	 */
	public static String[] getDayRange(String bday, String eday) {
	    GregorianCalendar rightNow = new GregorianCalendar(Integer.parseInt(bday.substring(0, 4)), Integer.parseInt(bday.substring(4, 6)) - 1, Integer.parseInt(bday.substring(6, 8)));
	    int i = 0;
	    String s = null;
	 ...
	 * 取差日
	 * 
	 * @param day   String 基准日YYYYMMDD
	 * @param delta int 基准日YYYYMMDD
	 * @return String 日期型字符
	 */
	public static String getDeltaDay(String day, int delta) {
	    GregorianCalendar rightNow = new GregorianCalendar(Integer.parseInt(day.substring(0, 4)), Integer.parseInt(day.substring(4, 6)) - 1, Integer.parseInt(day.substring(6, 8)));
	...
	public static String getSysTime() {
	    return getDefaultTimeFormat().format(java.util.Calendar.getInstance().getTime());
	}
	...
	public static String getCurrentWeek(){
		return getDefaultWeekFormat().format(java.util.Calendar.getInstance().getTime());
	}
	 ...
	 * 
	 * @param o java.lang.Object默认输入一个数字型的字符
	 * @return String字符串
	 */
    ...
    /**
     * 字符串转化为Map,格式为 k1,v1;k2,v2，或者格式为k1=v1;k2=v2
     * 不进行正确性检查
     */
    ...
    public static String rtrim(String str,String suffixs){
    	if(isNull(str) || isNull(suffixs))return str;
    	int i=str.length()-1;
    	for(;i>=0;i--){
