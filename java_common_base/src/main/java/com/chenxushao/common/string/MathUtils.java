...
public class MathUtils {
	 ...
	 */
	public static double interpolate(long x1, long x2, double y1, double y2,
			long x) {
	...
	/**
	 * Rundet die Zahl d auf die Position scale mit einer bestimmten
	 * Rundungsmethode roundMethod
	 */
	public static double setScale(double d, final int scale,
			final RoundMethod method) {
		int c = 0;
		long faktor = 1;
