...
/**
 * @author MjrTom 2006/Jan/02: added various methods, including some
 *         java.util.Random method aliases
 */
...
public class RandomUtils {
	...
	/**
	 * @return random int between min and max, e.g params of [5,7] returns 5,6
	 *         or 7
	 */
