 ...
 * Description: sap接口类型
 * </p>
 * Project: job Package: cn.com.gome.train.constant File: SapInterfaceType.java
 * 
...
public enum SapInterfaceType {
	...
	PositiveSapReceipt(1, "正向SAP收款"), NegativeSapReceipt(2, "逆向SAP收款"), PositiveSapIncome(
			3, "正向SAP收入"), NegativeSapIncome(4, "逆向SAP收入"), SapIncomeCallback(
			5, "SAP收入回调");
