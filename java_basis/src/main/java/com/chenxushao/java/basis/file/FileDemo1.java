...
public class FileDemo1 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("最后修改时间: "
				+ sdf.format(new Date(srcFile.lastModified())));
		System.out.println("字节数: " + srcFile.length());
		// 创建临时文件
		// System.out.println(srcFile.createNewFile());
		System.out.println();
		File srcFile2 = new File("d:" + fileSeprator + "xyzdir" + fileSeprator
				+ "LeoOrbit_2010_0722_1714.7z");
		System.out.println("-----基本属性-----");
		...
		System.out.println("最后修改时间: "
				+ sdf.format(new Date(srcFile2.lastModified())));
		...
		File src = new File("d:" + fileSeprator + "xyzdir" + fileSeprator
				+ "复件 xyzdir");
