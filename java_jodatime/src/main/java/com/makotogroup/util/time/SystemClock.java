...
/**
 * Serves as a wrapper for the system clock to be used by applications to
 * retrieve the system time, rather than System.currentTimeMillis(). This allows
 * us to set arbitrary times to exercise application logic without having to
 * alter the system time to do so.
 * 
 * @author steve
 *
 */
public interface SystemClock {
	 ...
	 * 
	 * @return - DateTime - a Joda DateTime object that contains the system
	 *         time.
	 */
	 ...
	 * 
	 * @return - DateMidnight - a Joda DateMidnight object that contains the
	 *         system time.
	 */
	 ...
	 * 
	 * @return - LocalDate - a Joda LocalDate object that contains the system
	 *         time.
	 */
	 ...
	 * 
	 * @return - LocalTime - a Joda LocalTime object that contains the system
	 *         time.
	 */
