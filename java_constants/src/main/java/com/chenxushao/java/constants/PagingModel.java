...
public class PagingModel<T> implements Serializable{
     ...
     */
    public  PagingModel(int currentPage,int perPageSize,Long totalRecordCount,List recordList) {
        ...
        //计算总页数
        this.totalPageCount = (int)Math.ceil(totalRecordCount / (double)perPageSize);
